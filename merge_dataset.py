...
def move_dependent_col_as_last(df):
    ...
    df.insert(df.shape[1], 'HOME_TEAM_WINS', tmp)
...
if __name__ == "__main__":
    ...
    games_details_avg = pd.read_csv('curated_data/game_details.csv')
    ...
    merged_df.to_csv('curated_data/full_dataset.csv', index=False)
